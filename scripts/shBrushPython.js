...
function Brush(){
var my_constant = 'DEF_FILE DEF_PORT tk CENTER ghidra program flatapi FlatProgramAPI ttk pyhidra PIPE struct treelib KeyboardInterrupt Node Tree pygame SERVICE_WIN32 SERVICE_STATE_ALL win32con win32service iter hashlib GENERIC_READ SC_MANAGER_ALL_ACCESS subprocess gtk glib MySQLdb idaapi os False True sys commands argparse gridfs pymongo MongoClient win32com.client win32 easywebadv password username protocol port verify_ssl googletrans Translator psutil __future__ print_function httplib2 io googleapiclient discovery oauth2client client tools Storage MediaFileUpload MediaIoBaseDownload acknowledgeAbuse fileId pageSize fields PyApp Window'
