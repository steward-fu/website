...
;(function()
{
  ...
  function Brush(){
    ...
    var my_keyword =  'initial module input output parameter wire assign always endmodule posedge CLK_DIV_PERIOD reg abs addr and exit stdcall external array Nil as asm begin cardinal case class comp const constructor destructor div do downto else end except exports extended false file include includelib extern push call ret option finalization finally for function goto if implementation in inherited initialization interface is label library mod nil not object of on or packed pointer private procedure program property pvariant protected public published raise record repeat set shl shr then threadvar to true try type unit until uses val var varirnt while with write writeln xor';
