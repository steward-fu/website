...
;(function()
{
  ...
  function Brush(){
    var my_constant = 'False True IRP_MJ_PNP LowPagePriority DO_DIRECT_IO WDF_NO_OBJECT_ATTRIBUTES IRP_MN_REMOVE_DEVICE IO_NO_INCREMENT STATUS_SUCCESS GENERIC_READ GENERIC_WRITE WDF_NO_HANDLE METHOD_BUFFERED IRP_MJ_DEVICE_CONTROL WdfDeviceIoBuffered WdfIoQueueDispatchSequential STATUS_PENDING NULL FILE_ANY_ACCESS METHOD_OUT_DIRECT METHOD_IN_DIRECT METHOD_NEITHER FILE_SHARE_READ STATUS_CANCELLED FILE_FLAG_OVERLAPPED DISPATCH_LEVEL KernelMode OPEN_EXISTING FILE_ATTRIBUTE_NORMAL INFINITE THREAD_ALL_ACCESS INVALID_HANDLE_VALUE IRP_MJ_CREATE IRP_MJ_CLOSE IRP_MJ_WRITE IRP_MJ_READ FILE_DEVICE_UNKNOWN Executive FALSE TRUE DO_BUFFERED_IO DO_DEVICE_INITIALIZING';
