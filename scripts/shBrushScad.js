...
;(function() {
 typeof(require) != 'undefined' ? SyntaxHighlighter = require('shCore').SyntaxHighlighter : null;
  ...
  function Brush() {
    ...
    var my_keyword =  'radius diameter angle height twist slices scale fn auto convexity module center for if else';
    var my_type = 'int';
    var my_function = 'circle surface import rotate_extrude linear_extrude minkowski color resize meniscus cube_round_corner echo difference translate rotate hull sphere cube cylinder union';
